...
<head>
    ...
    <title>Login Admin - Beranda Nusantara</title>
    ...
    <style>
        * {
        ...
        .image-side .logo-overlay img {
            width: 280px;           /* Ukuran logo yang lebih pas */
            height: auto;
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-form-side">
            ...
            <p class="subtitle">Masuk untuk mengelola konten budaya Nusantara</p>

            <form action="proses_login.php" method="POST">
                <div class="input-group">
                    <i class="fa-solid fa-envelope"></i>
                    <input type="email" placeholder="Email Admin" required name="email">
                </div>
                ...
                <button type="submit" class="btn-login" name="login">Masuk sebagai Admin</button>
            </form>
