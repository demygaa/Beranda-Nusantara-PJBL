...
<body>
        ...
        <div class="login-form-side">
            ...
            <form action="proses_login.php" method="POST" id="login">
                <div class="input-group">
                    ...
                    <input type="email" placeholder="Email pengguna" required name="email">
                </div>
                ...
                <div class="options">
                    <p>Lupa kata sandi? <span><button class="forgot-pass" type="button" id="forgotpass">Perbarui</button></span></p>
                ...
                <div class="options">
                    <p style="margin-top: 20px;">Belum punya akun? <span><a href="registeruser.php"
                                class="forgot-pass">Daftar Sekarang</a></span></p>
                </div>
            </form>

            <form action="kirimotp.php" method="POST" class="forgotpass">
                <label style="margin-bottom: 20px;">Email</label>
                <div class="input-group">

                    <i class="fa-solid fa-envelope"></i>
                    <input type="email" name="email" placeholder="Masukan email akun anda disni" required>

                </div>

                <button type="submit" name="kirim_otp" class="btn-login">
                    Kirim OTP
                </button>
    ...
    <script>
        const tombol = document.getElementById("forgotpass");
        const formForgot = document.querySelector(".forgotpass");
